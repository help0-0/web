        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-3 sm:mb-4">
              <Waves className="h-7 w-7 sm:h-8 sm:w-8 text-primary-400" />
              <span className="text-xl sm:text-2xl font-bold">Avontide</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors duration-300">
